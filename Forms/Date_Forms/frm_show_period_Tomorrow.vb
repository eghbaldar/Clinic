Public Class frm_show_period_Tomorrow

    Dim cl_period As New cl_period

    Private Sub frm_show_period_Tomorrow_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Me.Select_doctor_for_GroupSickTableAdapter.Fill(Me.Ds_Personal.Select_doctor_for_GroupSick)

        dgv.DataSource = cl_period.Select_Period_ByDate(cmb_doctor.SelectedValue, Now.AddDays(1)).Tables(0)
        AjustingDataGrid()
        lblDateToday.Text = ShamsiDate.Miladi2Shamsi(Now.AddDays(1), ShamsiDate.ShowType.LongDate)
