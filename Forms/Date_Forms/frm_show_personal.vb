...
Public Class frm_show_personal
    ...
    Private Sub frm_show_personal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Calling_dgv()
        ...
        Me.Select_expertiseTableAdapter.Fill(Me.Ds_Expertise.Select_expertise, 1)
    End Sub
    ...
    Private Sub Calling_dgv()
        dgv_show.DataSource = Exec.ReturnSelectFromSP("sp_select_Personal '" & txt_Search.Text & "'").Tables(0)
    End Sub
    ...
    Private Sub btn_Update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Update.Click
        ...
        Select Case cl.Update_Personal(ID, txt_Fname.Text, txt_Lname.Text, sex, img, -1, cmb_expertise.Text, _
                                        txt_phone.Text, txt_mobile.Text, txt_address.Text, 0, visibe)
            Case 0
                MessageBox.Show("اطلاعات پرسنل مورد نظر با موفقیت اصلاح شد.", "توجه", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Call_Filling()
            Case 1
                MessageBox.Show("فیلد های کلیدی باید پر شود.")
            Case 2
    ...
    Private Sub btn_DeletePersonal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_DeletePersonal.Click
        If MessageBox.Show("با حذف این پرسنل تمامی اطلاعات مرتبط با آن حذف می گردد،آیا مطمئن هستید؟", "توجه بسیار مهم", _
