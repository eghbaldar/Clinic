...
Public Class frm_define_Personal

    Dim cl As New cl_personal
    Dim FileNameAvatar As String
    Dim img As Byte()

    Private Sub frm_define_Personal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Me.PersonalTableAdapter.Fill(Me.Ds_Personal.Personal, 1)
    ...
    Private Sub btn_Insert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Insert.Click
        ...
        Select Case cl.Insert_Personal(txt_Fname.Text, txt_Lname.Text, sex, img, -1, _
                                       cmb_expertise.Text _
                           , txt_phone.Text, txt_mobile.Text, txt_address.Text, 1, True)
            Case 0
                MessageBox.Show("پرسنل جدید با موفقیت ثبت شد.", "توجه", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.PersonalTableAdapter.Fill(Me.Ds_Personal.Personal, 1)
                clear()
            Case 1
